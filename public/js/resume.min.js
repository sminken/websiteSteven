...
!function(t){"use strict";t('a.js-scroll-trigger[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var e=t(this.hash);if((e=e.length?e:t("[name="+this.hash.slice(1)+"]")).length)return t("html, body").animate({scrollTop:e.offset().top},1e3,"easeInOutExpo"),!1}}),t(".js-scroll-trigger").click(function(){t(".navbar-collapse").collapse("hide")}),t("body").scrollspy({target:"#sideNav"})}(jQuery),$(document).ready(function(){$("#characterLeft").text("140 characters left"),$("#message").keydown(function(){var e=$(this).val().length;if(140<=e)$("#characterLeft").text("You have reached the limit"),$("#characterLeft").addClass("red"),$("#btnSubmit").addClass("disabled");else{var t=140-e;$("#characterLeft").text(t+" characters left"),$("#btnSubmit").removeClass("disabled"),$("#characterLeft").removeClass("red")}})});